...
namespace Speckle.ConnectorUnity
{
  public class RecursiveConverter
  {
    ...
    private Action<Object> objectDestroyFunction;
    ...
    public  GameObject ConvertRecursivelyToNative(Base @base, string name)
    {
      ...
      objectDestroyFunction = Application.isEditor ? new Action<Object>(Object.DestroyImmediate) : Object.Destroy;
    ...
    private GameObject TryConvertItemToNative(object value)
    {
      ...
      if (!_converter.CanConvertToNative(@base))
      {
        ...
        if (!goos.Any())
        {
          //objectDestroyFunction.Invoke(go);
          ...
          {
            Debug.Log($"e is of type {e.GetType()} and is {{{e}}}");
          }
          return null;
        }
