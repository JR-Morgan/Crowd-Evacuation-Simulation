...
namespace PedestrianSimulation.Visualisation.Tests
{
    ...
    public class HeatmapHelperTests
    {
        ...
        [TestCase(1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f, 9f, 5)]
        [TestCase(2f, 16f, 128f, 4f, 32f, 256f, 8f, 64f, 512f, 3)]
        [TestCase(2f, 16f, 128f, 4f, 32f, 256f, 8f, 64f, 512f, 4)]
        [TestCase(2f, 16f, 128f, 4f, 32f, 256f, 8f, 64f, 512f, 5)]
        [TestCase(0.2f, 0.16f, 0.128f, 0.4f, 0.32f, 0.256f, 0.8f, 0.64f, 0.512f, 3)]
        [TestCase(0.2f, 0.16f, 0.128f, 0.4f, 0.32f, 0.256f, 0.8f, 0.64f, 0.512f, 4)]
        [TestCase(0.2f, 0.16f, 0.128f, 0.4f, 0.32f, 0.256f, 0.8f, 0.64f, 0.512f, 5)]
        [Test]
